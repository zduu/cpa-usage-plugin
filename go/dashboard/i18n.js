...
var I18N_MAP = {
  'zh-CN': {
    ...
    cache_write_placeholder: '默认输入的 1.25 倍',
    save: '保存',
    edit: '编辑',
    delete: '删除',
  ...
  'zh-TW': {
    ...
    output_price: '輸出價格',
    cache_price: '快取讀取價格',
    cache_write_price: '快取寫入價格',
    cache_placeholder: '預設同輸入',
    cache_write_placeholder: '預設為輸入的 1.25 倍',
    save: '儲存',
    edit: '編輯',
    delete: '刪除',
  ...
  'en': {
    ...
    cache_write_placeholder: 'Default to 1.25× input',
    save: 'Save',
    edit: 'Edit',
    delete: 'Delete',
  ...
  'ru': {
    ...
    cache_write_tokens: 'Токены записи кэша',
    ...
    cache_price: 'Цена чтения кэша',
    cache_write_price: 'Цена записи кэша',
    cache_placeholder: 'По умолч. как ввод',
    cache_write_placeholder: 'По умолч. 1,25× цены ввода',
    save: 'Сохранить',
    edit: 'Ред.',
    delete: 'Удалить',
