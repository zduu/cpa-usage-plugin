...
```text
pluginhost: plugin loaded plugin_id=usage-dashboard-zduu version=2.4.6 path=plugins/usage-dashboard-zduu-v2.4.6.so
pluginhost: plugin registered plugin_id=usage-dashboard-zduu plugin_name=用量统计 version=2.4.6 path=plugins/usage-dashboard-zduu-v2.4.6.so
```
...
plugins:
  configs:
    usage-dashboard-zduu:
      enabled: true
      update_enabled: true
      update_version: latest   # 或 v2.4.6
```
